...
if __name__ == "__main__":
    print("Healthcare MCP Server v2.0 starting...")
    print("Transport: SSE")
    print("Listening on http://0.0.0.0:8000")
    print("All patient data is SYNTHETIC - no real PHI used")
    print("-" * 60)
    print("Tools available (13 total):")
    print("  [Fixed]  calculate_procedure_cost  — + age, gender, budget_inr")
    print("  [Fixed]  lookup_hospital           — + enriched review data")
    print("  [Kept]   calculate_insurance_gap")
    print("  [Kept]   get_procedure_pathway")
    print("  [NEW P1] find_specialty_hospitals")
    print("  [NEW P1] get_top_doctors")
    print("  [NEW P2] find_hospitals_for_procedure  — + budget filter")
    print("  [NEW P2] get_hospital_review_scores")
    print("  [NEW P2] get_valid_options")
    print("  [NEW P3] get_all_procedure_variants")
    print("  [NEW P3] get_procedure_card")
    print("  [NEW P4] estimate_all_variants_cost")
    print("  [NEW P5] validate_inputs")
    print("-" * 60)
